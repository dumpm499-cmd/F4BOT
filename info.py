...
DATABASE_NAME = environ.get('DATABASE_NAME', "Filesearchbot")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'None')
CHNL_LNK = environ.get('CHNL_LNK', 'None')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'None') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'None')
